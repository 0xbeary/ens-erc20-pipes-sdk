...
export const events = {
    ...
    Claim: event("0x47cee97cb7acd717b3c0aa1435d004cd5b3c8c57d70dbceb4e4458bbd60e39d4", "Claim(address,uint256)", {"claimant": indexed(p.address), "amount": p.uint256}),
    ...
    MerkleRootChanged: event("0x1b930366dfeaa7eb3b325021e4ae81e36527063452ee55b86c95f85b36f4c31c", "MerkleRootChanged(bytes32)", {"merkleRoot": p.bytes32}),
...
export const functions = {
    ...
    claimPeriodEnds: viewFun("0x66deac47", "claimPeriodEnds()", {}, p.uint256),
    claimTokens: fun("0x76122903", "claimTokens(uint256,address,bytes32[])", {"amount": p.uint256, "delegate": p.address, "merkleProof": p.array(p.bytes32)}, ),
    ...
    isClaimed: viewFun("0x9e34070f", "isClaimed(uint256)", {"index": p.uint256}, p.bool),
    merkleRoot: viewFun("0x2eb4a7ab", "merkleRoot()", {}, p.bytes32),
    minimumMintInterval: viewFun("0x515b612a", "minimumMintInterval()", {}, p.uint256),
    mint: fun("0x40c10f19", "mint(address,uint256)", {"dest": p.address, "amount": p.uint256}, ),
    mintCap: viewFun("0x76c71ca1", "mintCap()", {}, p.uint256),
    name: viewFun("0x06fdde03", "name()", {}, p.string),
    nextMint: viewFun("0xcf665443", "nextMint()", {}, p.uint256),
    ...
    sweep: fun("0x01681a62", "sweep(address)", {"dest": p.address}, ),
...
export class Contract extends ContractBase {
    ...
    isClaimed(index: IsClaimedParams["index"]) {
...
export type MerkleRootChangedEventArgs = EParams<typeof events.MerkleRootChanged>
...
export type ClaimPeriodEndsParams = FunctionArguments<typeof functions.claimPeriodEnds>
export type ClaimPeriodEndsReturn = FunctionReturn<typeof functions.claimPeriodEnds>

export type ClaimTokensParams = FunctionArguments<typeof functions.claimTokens>
export type ClaimTokensReturn = FunctionReturn<typeof functions.claimTokens>
...
export type MinimumMintIntervalParams = FunctionArguments<typeof functions.minimumMintInterval>
export type MinimumMintIntervalReturn = FunctionReturn<typeof functions.minimumMintInterval>

export type MintParams = FunctionArguments<typeof functions.mint>
export type MintReturn = FunctionReturn<typeof functions.mint>

export type MintCapParams = FunctionArguments<typeof functions.mintCap>
export type MintCapReturn = FunctionReturn<typeof functions.mintCap>

export type NameParams = FunctionArguments<typeof functions.name>
export type NameReturn = FunctionReturn<typeof functions.name>

export type NextMintParams = FunctionArguments<typeof functions.nextMint>
export type NextMintReturn = FunctionReturn<typeof functions.nextMint>
